# Acceptable use: the hosted Hollow Grid worlds

**Scope.** This applies to use of the public worlds that Skyphusion Labs operates at
hollow.skyphusion.org and dustfall.skyphusion.org. The Hollow Grid is self-hosted software
(AGPL-3.0-only); if you run your own world, you set your own rules as its operator. This notice governs
our worlds. It is not legal advice.
...
Because Skyphusion Labs operates these worlds, we can and will act on abuse we become aware of. We may
rate-limit, suspend, or block access for abuse.
